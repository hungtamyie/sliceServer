class Game {
    constructor(data){
        ...
        this.lookup = [
            ...
            {manaRegen: 0.0013, maxMana: 5},
            {manaRegen: 0.0014, maxMana: 5},
            {manaRegen: 0.0015, maxMana: 6},
            {manaRegen: 0.0016, maxMana: 6},
            {manaRegen: 0.0017, maxMana: 7},
            {manaRegen: 0.0018, maxMana: 7},
            {manaRegen: 0.0019, maxMana: 8},
            {manaRegen: 0.002, maxMana: 8},
            {manaRegen: 0.0021, maxMana: 9},
            {manaRegen: 0.0022, maxMana: 9},
            {manaRegen: 0.0025, maxMana: 10},
            {manaRegen: 0.0027, maxMana: 10},
            {manaRegen: 0.003, maxMana: 11},
            {manaRegen: 0.0032, maxMana: 11},
            {manaRegen: 0.0035, maxMana: 12},
            {manaRegen: 0.004, maxMana: 12},
        ]
        this.outputEffects = [];
        this.winner = "none";
        if(data){
